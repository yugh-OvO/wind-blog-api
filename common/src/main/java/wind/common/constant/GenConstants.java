...
public interface GenConstants {
     ...
     * BO对象 不需要添加字段
     */
    String[] COLUMNNAME_NOT_ADD = {"create_by", "create_time", "update_by",
        "update_time", "version"};

    /**
     * BO对象 不需要编辑字段
     */
    String[] COLUMNNAME_NOT_EDIT = {"create_by", "create_time", "update_by",
        "update_time", "version"};

    /**
     * VO对象 不需要返回字段
     */
    String[] COLUMNNAME_NOT_LIST = {"create_by", "create_time", "update_by",
        "update_time", "version"};

    /**
     * BO对象 不需要查询字段
     */
    String[] COLUMNNAME_NOT_QUERY = {"id", "create_by", "create_time", "update_by",
