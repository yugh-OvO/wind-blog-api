...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            operationLog.setName(LoginHelper.getUsername());

            if (e != null) {
                operationLog.setStatus(GlobalConstants.FAIL);
    ...
    private void setRequestValue(JoinPoint joinPoint, OperationLogDTO operationLog) throws Exception {
        ...
        if (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod)) {
            ...
            operationLog.setParam(StringUtils.substring(paramsMap.toString(), 0, 2000));
        }
    }
